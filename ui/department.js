const department = {
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <button type="button" v-if="DepartmentId == 0" class="btn btn-primary" @click="createClick()">Create</button>
                            <button type="button" v-if="DepartmentId != 0" class="btn btn-primary" @click="updateClick()">Update</button>
    ...
    methods: {
        refreshData() {
            ...
            axios.get(`${variables.API_URL}department`)   // template string
                .then((response) => {
