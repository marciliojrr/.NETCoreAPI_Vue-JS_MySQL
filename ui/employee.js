const employee = {
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="d-flex flex-row bd-highlight mb-3">
                                ...
                                <!-- Div for photo -->
                                <div class="p-2 w-50 bd-highlight">
                                    <img width="150" height="150" :src="PhotoPath+PhotoFileName" />
                                    <input class="m-2" type="file" @change="imageUpload">
                                </div>

                            </div>

                            <button type="button" v-if="EmployeeId == 0" class="btn btn-primary" @click="createClick()">Create</button>
                            <button type="button" v-if="EmployeeId != 0" class="btn btn-primary" @click="updateClick()">Update</button>
    ...
    methods: {
        refreshData() {
            //axios.get(variables.API_URL + "department") // modo normal
            axios.get(`${variables.API_URL}employee`)   // template string
                .then((response) => {
        ...
        deleteClick(id) {
            ...
            axios.delete(`${variables.API_URL}employee/${id}`)
                //axios.get(variables.API_URL + "department/" + id)
                .then((response) => {
                    this.refreshData();
                    alert(response.data);
                });
